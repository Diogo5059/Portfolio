...
social = [
  ...
  'github         <a href="' + github + '" target="_blank">github/Diogo5059' + "</a>",
  "<br>"
];
...
help = [
  "<br>",
  '<span class="command">whois</span>          Who is Amaral?',
  '<span class="command">whoami</span>         Who are you?',
  '<span class="command">social</span>         Display social networks',
  '<span class="command">secret</span>         Find the password',
  '<span class="command">projects</span>       View coding projects',
  '<span class="command">email</span>          Email me if your interested',
...
banner = [
  '<span class=\"command\">Diogo Amaral (DA) Not A Corporation. All rights reserved. © 2024</span>',
  "         ___   ____",
"       /' --;^/ ,-_\\     \\ | /                                  ",
"      / / --o\\ o-\\ \\\\   --(_)--     ",
"     /-/-/|o|-|\\-\\\\|\\\\   / | \\              ░▒▓██████▓▒░░▒▓██████████████▓▒░ ░▒▓██████▓▒░░▒▓███████▓▒░ ░▒▓██████▓▒░░▒▓█▓▒░          ",      
